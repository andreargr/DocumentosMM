...
# print(len(mappings_test),len(mappings_train),len(mappings_validation))
# print(mappings)
...
def prepare_data_ft(): #upload training and validation file to openai
...
if __name__ == "__main__":
    jsonl_converter(mappings_train,mappings_validation,"mejora")
    create_job()
